/**
 * ============================================================================= 
 * REMINDER ALERT MODAL - PORTAL-BASED CENTERING SOLUTION
 * =============================================================================
 * 
 * Uses React Portal to render modal directly at document.body level,
 * completely bypassing any parent container positioning conflicts.
 * =============================================================================
 */
...
const ReminderAlertModal = ({
    ...
    useEffect(() => {
        if (isOpen && reminder) {
            ...
            document.body.classList.add('rb-reminder-open');
            
            window.__reminderScrollY = originalScrollY;
        }
        
        return () => {
            const scrollY = window.__reminderScrollY || 0;
            document.body.style.position = '';
            document.body.style.top = '';
            document.body.style.width = '';
            document.body.style.overflow = '';
            document.body.classList.remove('rb-reminder-open');
